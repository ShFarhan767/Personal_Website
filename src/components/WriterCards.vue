        ...
        <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-5 xl:gap-10 lg:gap-16 place-items-center mb-14">
                <div class="lg:col-span-2">
                    <h2
                        class="text-interface-100 font-bold text-4xl leading-normal lg:text-5xl capitalize lg:leading-snug dark:text-white">
                        Editor &
                        <span class="relative">
                ...
                <div class="lg:col-span-3">
                    ...
                    <p class="text-[#747681] text-xl z-30 relative -mt-52">
                        Donec dignissim, metus sit amet susc elementum, arcu mauris vulputate odio, quis cursus nunc urna id
                        tellus. Quis que hendre rit commodo dignissim.
                    </p>
                </div>
            </div>
            <div class="swiper-container overflow-hidden">
                <div class="swiper-wrapper pb-14 lg:pb-16">
                        <article class="swiper-slide swiper-slide-prev" role="group" aria-label="3 / 4"
                            ...
                            <div class="relative transition duration-200 cursor-pointer px-7 py-8 bg-white group hover:bg-[#ff3f00] shadow-customThree rounded-custom overflow-hidden dark:bg-slate-900">
                                <div class="w-[70px] h-[70px] rounded-full bg-[#ff3f00] group-hover:bg-white group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6">
                                    <svg class="fill-[#ff3f00] group-hover:fill-white" width="58" height="58"
                                ...
                                <a href="#!"
                                    class="underline relative z-10 flex items-center text-interface-100 group-hover:text-white dark:text-white">
                                    <span>Learn more</span>
                                    <svg class="stroke-interface-100 group-hover:stroke-white" width="25" height="26"
                                        viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.10156 18.0748L17.2491 7.92383" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M7.10156 7.92383H17.2491V18.0748" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                    </svg>
                                </a>
                        ...
                        <article class="swiper-slide swiper-slide-active" role="group" aria-label="4 / 4"
                            style="width: 385.333px; margin-right: 30px;" data-swiper-slide-index="3">
                            <div
                                class="relative transition duration-200 cursor-pointer px-7 py-8 bg-white group hover:bg-[#ff3f00] shadow-customThree rounded-custom overflow-hidden dark:bg-slate-900">
                                <div
                                    class="w-[70px] h-[70px] rounded-full bg-[#ff3f00] group-hover:bg-white group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6">
                                    <svg class="stroke-[#ff3f00] group-hover:stroke-white" width="58" height="58"
                                        viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="#!"
                                    class="underline flex relative z-10 items-center text-interface-100 group-hover:text-white dark:text-white">
                                    <span>Learn more</span>
                                    <svg class="stroke-interface-100 group-hover:stroke-white" width="25" height="26"
                                        viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.10156 18.0748L17.2491 7.92383" stroke-width="1.5" stroke-linecap="round"
                    ...
                    <article class="swiper-slide" role="group" aria-label="2 / 4"
                        style="width: 385.333px; margin-right: 30px;" data-swiper-slide-index="1">
                        <div
                            class="relative transition duration-200 cursor-pointer px-7 py-8 bg-white group hover:bg-[#ff3f00] shadow-customThree rounded-custom overflow-hidden dark:bg-slate-900">
                            <div
                                class="w-[70px] h-[70px] rounded-full bg-[#ff3f00] group-hover:bg-white group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6">
                                <svg class="stroke-[#ff3f00] group-hover:stroke-white" width="58" height="58"
                                    ...
                                    <path
                                        ...
                                        stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M17.8398 51.2344H40.1611" stroke-width="2" stroke-miterlimit="10"
                                    ...
                                    <path
                                        ...
                                        stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M40.6029 27.5059L36.3848 31.8119L42.6242 33.7453L40.6029 27.5059Z"
                                        stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M28.6504 24.0776L36.3837 31.811L40.6019 27.5049L33.5716 20.4746"
                                        stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M22.3242 37.4355H35.9454" stroke-width="2" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M15.3809 41.3906H42.8869" stroke-width="2" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>

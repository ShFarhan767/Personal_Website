        ...
        <div class="container mx-auto pb-10">
            <div class="">
                <div class="max-w-xl w-full mx-auto mb-10 text-center">
                    ...
                    <h2 class="text-4xl xl:text-5xl xl:leading-snug font-bold text-interface-100 dark:text-white">
                        ...
                        <span class="text-interface-100 Line">Case Results</span>
                    </h2>
                </div>
            </div>
            ...
            <div class="mt-12">
                <div class="grid grid-cols-1 lg:grid-cols-2 items-center h-auto" data-aos="fade-in">
                    ...
                    <div class="bg-[#050f25] pb-8 border-r" data-aos="fade-up" data-aos-duration="2000">
                        <div class="About_BG"></div>
                        <div class="relative z-10">
...
.animated-image {
    animation: moveUpDown 2.5s infinite alternate; /* Adjust duration and timing function as needed */
}
